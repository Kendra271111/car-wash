...
const CreateOrders = () => {
  ...
  const [options, setOptions] = useState<OptionsState>({ services: [], vehicles: [], customers: [], staff: [] })
                    ...
                    cartItems.map((item, index) => {
                      ...
                      return (
                        <tr key={index}>
                          ...
                          <td>{item.empty ? '-' : Number(item.price).toFixed(2)}</td>
                          <td>
                            {!item.empty && (
